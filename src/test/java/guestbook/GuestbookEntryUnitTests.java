...
class GuestbookEntryUnitTests {
	...
	void rejectsEmptyText() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)//
				.isThrownBy(() -> new GuestbookEntry("Ollie", "oliver.gromm@web.de", ""));
	}

	@Test
	void setsCreationDate() {
		assertThat(new GuestbookEntry("Ollie", "oliver.gromm@web.de", "May the 4th be with you!").getDate()).isNotNull();
	}
}
