...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "Hax@louds.com", "first!!!"), //
					new GuestbookEntry("Arni", "arnold.barth@hotmail.de", "Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "lux.haram@web.de",
							"It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337", "gulp@t-online.de",
