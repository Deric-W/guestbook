...
class GuestbookController {
    ...
    /**
     * Creates a new {@link GuestbookController} using the given {@link GuestbookRepository}. Spring will look for a
     * bean of type {@link GuestbookRepository} and hand this into this class when an instance is created.
     *
    ...
    /**
     * Handles requests to create a new {@link GuestbookEntry}. Spring MVC automatically validates and binds the HTML
     * form to the {@code form} parameter. Validation or binding errors, if any, are exposed via the {@code
     * errors} parameter.
     *
    ...
    /**
     * Deletes a {@link GuestbookEntry}. This request can only be performed by authenticated users with admin
     * privileges. Also note how the path variable used in the {@link DeleteMapping} annotation is bound to an
     * {@link Optional} parameter of the controller method using the {@link PathVariable} annotation. If the entry
     * couldn't be found, that {@link Optional} will be empty.
     *
    ...
    /**
     * Handles AJAX requests to create a new {@link GuestbookEntry}. Instead of rendering a complete page, this view
     * only renders and returns the HTML fragment representing the newly created entry.
     * <p>
